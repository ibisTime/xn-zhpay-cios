...
//AJ_GMHZB("-36", "购买汇赚宝"), AJ_GMHZBFC("37", "购买汇赚宝分成"), AJ_YYJL("38", "汇赚宝摇一摇奖励"), AJ_YYFC("39", "摇一摇分成"), AJ_DUOBAO("-40", "一元夺宝"), AJ_DBFLOW("41", "夺宝流标"), AJ_HB2FR("50", "红包兑分润"), AJ_HBYJ2FR("52", "红包业绩兑分润"), AJ_HBYJ2GXJL("54", "红包业绩兑贡献值"), AJ_FR2RMB("56",
//"分润兑人民币"), AJ_GXJL2RMB("58", "贡献值兑人民币");
@end
