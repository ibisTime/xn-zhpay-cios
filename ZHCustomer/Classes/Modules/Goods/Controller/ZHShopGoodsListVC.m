...
@implementation ZHShopGoodsListVC
...
- (void)viewDidLoad {
    ...
    tableView.placeHolderView = [TLPlaceholderView placeholderViewWithText:@"该店铺暂无商品"];
    ...
    helper.code = @"808028";
    helper.parameters[@"companyCode"] = self.shopMasterUserId;
